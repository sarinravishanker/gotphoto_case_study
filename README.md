...
- [Approach](#approach)
  ...
  - [Model Design Reasoning](#model-design-reasoning)
  - [Potential Business Questions Answered](#potential-business-questions-answered)
  - [Incremental Loading](#incremental-loading)
- [dbt Tests Implemented](#dbt-tests-implemented)
- [Tech Stack](#tech-stack)
- [Quick Start](#quick-start)
  - [Prerequisites](#prerequisites)
  - [Environment Setup](#1-environment-setup)
  - [Update Snowflake Configuration](#2-update-snowflake-configuration)
  - [Build and Start Services](#3-build-and-start-services)
  - [Run dbt Pipeline](#4-run-dbt-pipeline)
